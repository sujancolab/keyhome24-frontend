...
const Step5Payment: React.FC<Step5PaymentProps> = ({ onBack, onSubmit }) => {
    ...
    const [paymentMethod, setPaymentMethod] = useState<"card" | "twint">(
        "card"
    );
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        e.currentTarget.innerHTML = "Chargement...";
                    ...
                    {plans.map((plan) => (
                        ...
                        >
                            ...
                            <p className="text-2xl font-bold text-gray-900 mb-4">
                                ...
                                <span className="text-sm font-normal">CHF</span>
                            </p>
                ...
                {paymentMethod === "twint" && (
                    <div className="mt-6 p-6 bg-blue-50 rounded-lg text-center">
                        ...
                        <p className="text-blue-800">
                            Scannez ce QR code avec votre application TWINT pour
                            payer
                        </p>
                    </div>
                )}
                ...
                <div className="mt-6">
                    <label className="flex items-start space-x-3">
                        ...
                        <span className="text-sm text-gray-600">
                            J'accepte les conditions de publication et la
                            politique de confidentialité. Je comprends que le
                            paiement est non remboursable.
                        </span>
                    </label>
                </div>
            </div>
